// src/layouts/profile/components/CarInformations/index.js
import React from "react";
import { Card, Stack, Grid, CircularProgress } from "@mui/material";
...
const CarInformations = () => {
  ...
  return (
    <Card
      sx={({ breakpoints }) => ({
        [breakpoints.up("xxl")]: { maxHeight: "400px" },
      })}
    >
      <VuiBox display="flex" flexDirection="column">
        ...
        <VuiTypography variant="button" color="text" fontWeight="regular" mb="30px">
          {loading ? "Loading..." : `Hello, ${user?.name || "Guest"}! Your Car is ready.`}
        </VuiTypography>
        ...
        <Stack
          ...
          background="#fff"
          sx={({ breakpoints }) => ({
            [breakpoints.up("sm")]: { flexDirection: "column" },
            [breakpoints.up("md")]: { flexDirection: "row" },
            [breakpoints.only("xl")]: { flexDirection: "column" },
          })}
        >
          {/* Progress + time to full charge */}
          <VuiBox
            display="flex"
            flexDirection="column"
            justifyContent="center"
            sx={({ breakpoints }) => ({ [breakpoints.only("sm")]: { alignItems: "center" } })}
            alignItems="center"
          >
            ...
            <VuiBox display="flex" justifyContent="center" flexDirection="column" sx={{ textAlign: "center" }}>
          ...
          {/* Three mini cards w/ charts and stats */}
          <Grid
            container
            sx={({ breakpoints }) => ({
              spacing: "24px",
              [breakpoints.only("sm")]: { columnGap: "0px", rowGap: "24px" },
              [breakpoints.up("md")]: { gap: "24px", ml: "50px !important" },
              [breakpoints.only("xl")]: { gap: "12px", mx: "auto !important" },
            })}
          >
              ...
              >
                <VuiBox display="flex" flexDirection="column" mr="auto">
                  ...
                  <VuiTypography color="white" variant="h4" fontWeight="bold" sx={({ breakpoints }) => ({
                    [breakpoints.only("xl")]: { fontSize: "20px" },
                  })}>
                    76%
                  </VuiTypography>
                </VuiBox>
                <VuiBox
                  ...
                  justifyContent="center"
                  alignItems="center"
                  sx={{ background: info.main, borderRadius: "12px", width: "56px", height: "56px" }}
                >
            ...
            <Grid item xs={12} md={5.5} xl={5.8} xxl={5.5}>
              ...
              >
                ...
                <VuiBox display="flex" justifyContent="center" alignItems="center" sx={{
                  background: info.main, borderRadius: "12px", width: "56px", height: "56px",
                }}>
