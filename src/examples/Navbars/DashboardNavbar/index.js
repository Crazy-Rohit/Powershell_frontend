/*!
=========================================================
* Vision UI Free React - DashboardNavbar (with Avatar + Logout)
=========================================================
*/
          ...
          <VuiBox sx={(theme) => navbarRow(theme, { isMini })}>
            ...
            <VuiBox color={light ? "white" : "inherit"} display="flex" alignItems="center">
              {!user ? (
                ...
                <>
                  <IconButton onClick={handleOpenUserMenu} sx={navbarIconButton} size="small">
                    <Avatar
                      src={team2}
                      alt={user.name}
                      sx={{ width: 36, height: 36, border: "2px solid #42a5f5" }}
                    />
                  </IconButton>
                  {renderUserMenu}
                </>
